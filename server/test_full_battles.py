...
from battle_engine import BattleSimulator, PlacedItem, Player, ACTION_CODES
from item_effects import (
    ItemSpec, TimerTrigger, BattleStartTrigger, DamageTakenTrigger, PassiveTrigger,
    AttackEffect, HealEffect, BlockEffect, BuffEffect, DebuffEffect, 
    StatModEffect, ConsumeEffect, create_example_items
)
...
class TestFullBattleScenarios:
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=2.5,
                        cpu_cost=3,
                        effects=[AttackEffect(min_damage=4, max_damage=8, accuracy=0.85, crit_chance=0.2)]
                    )]
                ),
                position=(0, 0),
                uid="p1_null"
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=3.0,
                        cpu_cost=2,
                        effects=[AttackEffect(min_damage=2, max_damage=4, accuracy=0.95, special="stacking")]
                    )]
                ),
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=1.5,
                        cpu_cost=4,
                        effects=[AttackEffect(min_damage=3, max_damage=6, accuracy=0.75, crit_chance=0.3)]
                    )]
                ),
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=2.0,
                        cpu_cost=2,
                        effects=[AttackEffect(min_damage=3, max_damage=5, accuracy=0.85)]
                    )]
                ),
                position=(1, 1),  # Center
                uid="p1_bug1"
        ...
        p2_items = [
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    category="defense",
                    triggers=[OnAttackedTrigger(
                        effects=[ShieldBlockEffect(block_chance=0.4, block_amount=6)]
                    )]
                ),
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=2.0,
                        cpu_cost=3,
                        effects=[AttackEffect(min_damage=6, max_damage=8, accuracy=0.9)]
                    )]
                ),
                position=(0, 0),
                uid="p1_attack"
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        ...
                        effects=[AttackEffect(min_damage=8, max_damage=12, accuracy=0.85)]
                    )]
                ),
                position=(1, 0),
                uid="p2_heavy"
    ...
    def test_late_game_high_powered_battle(self):
        ...
        p1_items = [
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=2.5,
                        cpu_cost=4,
                        effects=[AttackEffect(min_damage=8, max_damage=12, accuracy=0.9)]  # High damage
                    )]
                ),
                position=(0, 0),
                uid="p1_weapon"
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    rarity="rare",
                    triggers=[OnAttackedTrigger(
                        effects=[ShieldBlockEffect(block_chance=0.4, block_amount=12)]
                    )]
                ),
                position=(1, 0),
                uid="p1_shield"
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=3.0,
                        cpu_cost=5,
                        effects=[AttackEffect(min_damage=10, max_damage=15, accuracy=0.85, crit_chance=0.25)]  # Very high damage
                    )]
                ),
                position=(0, 0),
                uid="p2_legendary"
        ...
        damage_actions = [a for a in result["actions"] if a["a"] == ACTION_CODES["DAMAGE"]]
        
        # Upgraded weapon should deal 8-12 damage
        # Legendary weapon should deal 10-15 damage
        p2_legendary_damage = [a for a in damage_actions if a.get("i") == "p2_legendary" and a["p"] == 1]
        if p2_legendary_damage:
            ...
            if successful_hits:
                ...
                assert max_damage >= 10, f"Legendary weapon max damage should be at least 10, got {max_damage}"
    ...
    def test_fatigue_mechanic_stalemate(self):
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=3.0,
                        cpu_cost=2,
                        effects=[AttackEffect(min_damage=2, max_damage=3, accuracy=0.95)]
                    )]
                ),
                position=(0, 0),
                uid="p1_weak"
        ...
        late_damage = [a for a in result["actions"] if a["a"] == ACTION_CODES["DAMAGE"] and a["t"] > 30]
        if late_damage:
    ...
    def test_cpu_management_battle(self):
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        ...
                        effects=[AttackEffect(min_damage=7, max_damage=9, accuracy=0.9)]
                    )]
                ),
                position=(0, 0),
                uid="p1_exp1"
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=1.2,
                        cpu_cost=5,
                        effects=[AttackEffect(min_damage=6, max_damage=8, accuracy=0.85)]
                    )]
                ),
                position=(1, 0),
                uid="p1_exp2"
            ...
            PlacedItem(
                spec=ItemSpec(
                    ...
                    triggers=[TimerTrigger(
                        cooldown=1.5,
                        cpu_cost=2,  # Low cost
                        effects=[AttackEffect(min_damage=4, max_damage=5, accuracy=0.95)]
                    )]
                ),
                position=(1, 0),
                uid="p2_eff1"
        ...
        assert len(p2_cpu_fails) < len(p1_cpu_fails), "Player 2 should have better CPU management"
