...
from item_effects import (
    AttackEffect, HealEffect, BlockEffect, BuffEffect, DebuffEffect, StunEffect,
    ReflectEffect, StatModEffect,
    TimerTrigger, BattleStartTrigger, DamageTakenTrigger, DamageDealtTrigger,
    PassiveTrigger, KillTrigger,
    ItemSpec, create_example_items
)
...
class TestTriggers:
    ...
    def test_battle_start_trigger(self):
        ...
        trigger = BattleStartTrigger(
            effects=[BlockEffect(block_amount=5)]
        )
    ...
    def test_damage_dealt_trigger(self):
        ...
        trigger = DamageDealtTrigger(
            ...
            effects=[StunEffect(stun_duration=1.0)]
        )
